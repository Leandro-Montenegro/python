# 3. Ventas
# Se pide cargar las n ventas del día de un comercio en 2 vectores. De cada venta se conoce el artículo adquirido
# (son 4 tipos de artículos numerados del 0 al 3) y la cantidad vendida de dicho artículo en esa venta.
#
